    ...
    <div className='header' id='header'>
        ...
        <div className="text-header">
            ...
            <div className="paragraph">
                ...
                Appartamenti dal design ricercato con <strong>ampi spazi esterni</strong> esclusivi. <Link to="Progetto" smooth={true} duration={1000} offset={-110}><strong>Scopri il progetto.</strong></Link>
            </div>
        </div>
